...
修正了push到下个页面再pop回来时tabbar显示问题

## Screenshots

1             |  2             |3             |4
:-------------------------:|:-------------------------:|:-------------------------:|:-------------------------:
![](Screenshots/PTCardTabBar-1.png)  |  ![](Screenshots/PTCardTabBar-2.png)  |  ![](Screenshots/PTCardTabBar-3.png)  |  ![](Screenshots/PTCardTabBar-4.png)
